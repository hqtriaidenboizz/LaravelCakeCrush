...
class PageController extends Controller
{
    ...
    public function postCheckout(Request $req)
    {
        ...
        $message = [
            ...
            'thanks' => 'Cảm ơn ' . $req->name . ' đã mua hàng ở cửa hàng chúng tôi.',
            'cart' => $cart,
            'content' => 'Đơn hàng sẽ được vận chuyển và giao cho khách hàng trong thời gian sớm nhất có thể.',
        ];
    ...
    public function vnpay_payment()
    {
        ...
        $vnp_TmnCode = "WSAYIB5N"; //Mã website tại VNPAY 
        $vnp_HashSecret = "GSFBLIILTXXYAYXYXCKBHJIOUCVVSIYG"; //Chuỗi bí mật

        $vnp_TxnRef = rand(1, 1000000); //Mã đơn hàng. Trong thực tế Merchant cần insert đơn hàng vào DB và gửi mã này sang VNPAY
